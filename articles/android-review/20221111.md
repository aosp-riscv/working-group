...
- 2275175: Add locally built riscv64-android-linux platform sysroot. 测试方法：`lunch aosp_riscv64-userdebug && m ndk_sysroot bionic_sysroot_crt_objects dist`
           这是一个新建的仓库 https://android.googlesource.com/toolchain/prebuilts/sysroot/platform/riscv64-linux-android/。 我理解是目前移植 riscv 的过程中临时建的，当前还没有为 riscv 做好 NDK，但是需要构建成功 libclang_rt.*，所以临时做了这一份 sysroot。具体参考相关 PR: 2261059。正式发布中应该不会有这个仓库。有待观察。
	   具体构建出来的 libclang_rt.* 由 2246653 负责加入 prebuilts/clang/host/linux-x86/， 这样 aosp 构建就可以执行 clang 的交叉编译了。
...
- https://android-review.googlesource.com/c/platform/frameworks/av/+/2252173
...
- 2252173：Add riscv64 seccomp policy for codec2
```
...
- https://android-review.googlesource.com/c/platform/external/libchrome/+/2287894

- https://android-review.googlesource.com/c/platform/development/+/2287094
...
- 2287894: platform/external/libchrome

- 2287094: platform/development, Remove renderscript related samples
